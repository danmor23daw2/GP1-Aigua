window.onload = function () {
    const puntos = [
        ...
        { x: 670, y: 300, video: 'img/CampoGolfRegandose.mp4', texto: 'Información del segundo punto.' },
        { x: 860, y: 360, video: 'img/CompeticionAcuatica.mp4', texto: 'Información del tercer punto.' },
